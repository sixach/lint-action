 ...
 */
function checkOutRemoteBranch(context: GithubContext): void {
 ...
 */
function commitChanges(message: string, skipVerification: boolean): void {
 ...
 * @param {boolean} skipVerification - Skip Git verification
 */
function pushChanges(skipVerification: boolean): void {
 ...
 */
function setUserInfo(name: string, email: string): void {
